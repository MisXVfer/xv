  ...
  return (
    <div className="min-h-screen bg-[#f5e6e8]">
      ...
      <div className="relative px-4 pb-12">
        ...
        {/* Sección Notas */}
        <div className="py-20 md:py-32 px-6 bg-gradient-to-b from-[#f5e6e8] via-white to-[#f5e6e8]">
          <div className="max-w-4xl mx-auto space-y-24 md:space-y-32">
            ...
            <div className="relative">
              <div className="max-w-3xl mx-auto relative z-10">
                ...
                <div className="text-center mb-12">
                  <div className="flex items-center justify-center gap-4 mb-6">
                    <div className="flex-1 h-px bg-gradient-to-r from-transparent via-[#B8936E]/60 to-[#B8936E]/60"></div>
                    <div className="relative">
                      <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif italic text-[#B8936E] relative z-10">Dress Code</h2>
                      <div className="absolute inset-0 blur-sm bg-[#B8936E] opacity-20"></div>
                    </div>
                    <div className="flex-1 h-px bg-gradient-to-l from-[#B8936E]/60 to-transparent"></div>
                  </div>
                </div>
                ...
                <div className="flex justify-center mb-10">
                  <div className="relative">
                    <div className="absolute inset-0 bg-[#A07D5C]/10 rounded-full blur-2xl scale-150"></div>
                    <img 
                      src={`${basePath}images/vestuario.svg`} 
                      alt="Dress Code" 
                      className="relative w-16 h-16 md:w-20 md:h-20 opacity-80"
                      style={{ filter: 'brightness(0) saturate(100%) invert(60%) sepia(20%) saturate(700%) hue-rotate(10deg) brightness(90%) contrast(85%)' }}
                    />
                  </div>
                </div>
                ...
                <div className="text-center px-6 space-y-6">
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                    Agradecemos su colaboración manteniendo un atuendo <span className="font-medium text-[#A07D5C]">Formal</span> para la celebración.
                  </p>
                  <div className="w-12 h-px bg-[#B8936E]/30 mx-auto"></div>
                  <p className="text-gray-600 text-base md:text-lg leading-relaxed italic">
                    El color <span className="font-medium text-[#B8936E]">Rose Gold</span> está reservado de manera exclusiva para la Quinceañera.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="max-w-3xl mx-auto relative z-10">
                ...
                <div className="flex justify-center mb-10">
                  <div className="relative">
                    <div className="absolute inset-0 bg-[#B8936E]/10 rounded-full blur-2xl scale-150"></div>
                    <img 
                ...
                <div className="text-center px-6 space-y-6">
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                    Su compañía es nuestro <span className="font-medium text-[#B8936E]">mejor regalo</span>.
                  </p>
                  <div className="w-12 h-px bg-[#B8936E]/30 mx-auto"></div>
                  <p className="text-gray-600 text-base md:text-lg leading-relaxed italic">
                    Si desean tener un presente, les agradeceríamos que este sea en efectivo.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="max-w-3xl mx-auto relative z-10">
                ...
                <div className="text-center px-6 space-y-8">
                  <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
                    Recuerda confirmar tu asistencia antes del <span className="font-medium text-[#B8936E]">20 de Enero de 2026</span>.
                  </p>
                  <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                    Puedes hacerlo dando clic en el botón "Confirmar"
                  </p>
